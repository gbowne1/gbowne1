...
I am experienced in Mechanical CAD, CAM and CNC Propgramming. I do not do architectural drawing, although I learned it in  The core of my experience is primarily AutoCAD 2002-2009, but switched to Fusion 360 in mid 2013.  I became an Autodesk Certified Instructor in July 2005.  

I occasionally do CNC programming for milling and lathes for a fee, but you must have a model available. 
...
In 1997, I built a functional ERP and MRP (with some CRM too) system for a 50 employee small job shop / machine and fabricaion shop with Access and Excel with database using SQL complete with dashboard and some Office 95/97/98 functionality to replace a RBASE:5000 system that ran in DOS 6.22

Between 1997 to 2007 I built computers for people that needed custom built computers, mainly people who couldn't afford.  I stopped doing this due to market saturation.
...
I love building antennas for 500kHz through 1.3Ghz, especially 500kHz through 1.8 MHz.  Mainly copper pipe loop antennas and some ultra-thin wire MW loop antennas.  I actively participate in local radio DX parties.
The furthest away radio station on AM/MW I have heard is one radio station in Roswell, NM.  

I am active on GMRS and FRS in my area.  Plans for 2022 include getting my CB (10/11m) dipole antenna back up in the air.  I also intend on doing some DTV/HDTV DXing and getting better TV antennas up.
...
* a modern dual Pentium II mainboard/motherboard
...
I have a 2nd system for doing CAD and CAM programming for CNC machinery.  I also have a system running MX Linux for doing audio and video production.  
...
* The Art of Tech:NPWAFT website for our group. Please see: https://www.github.com/gbowne1/taotnpwaft_site/
...
* C++ Game: Possibly a 1970s `Star Trek` or space type text based game complete with play better fields.
...
### I would like to learn
  ...
  Vue|Material UI|Angular|NPM|Mocha
  ESLint|Axios|Vim|Lodash|IntelliJ IDEA
...
There may be some paid staff positions in the future.

## Contact

📫 How to reach me: I have Instagram, Facebook, LinkedIn, Twitch, YouTube. all have the same name and github ID as this repo.  Reach out to me if you would like to help with any of my projects or with TAOT:NPWAFT.  Most of the repos have the Discussions tab turned on.  I always use gbowne1 for a user name.
...
👀 I’m interested in ... learning more about Bash, 
📫 How to reach me ...
